...
HD_PWD='O:/ENGS31/Final_Project/Vivado/FinalProject/FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ball_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ball_toplevel.tcl
