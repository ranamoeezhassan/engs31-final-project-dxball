...
HD_PWD='O:/ENGS31/Final_Project/Vivado/FinalProject/FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ball_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ball_toplevel.tcl -notrace
